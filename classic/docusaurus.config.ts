...
const config: Config = {
  ...
  url: "https://rutujaac.github.io/",
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: "/pebblo-docs-private/",
  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: "rutujaac", // Usually your GitHub org/user name.
  projectName: "pebblo-docs-private", // Usually your repo name.
  onBrokenLinks: "throw",
